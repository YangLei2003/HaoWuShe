          ...
          <div class="note-scroller" ref="noteScroller" @scroll="loadMoreData">
            <div class="note-content">
              ...
              <div class="product-card-container">
                <div v-if="noteInfo.productId" class="product-card-minimal" @click="toProductDetail(noteInfo.productId)">
                  <div class="product-info-minimal">
                    <span class="product-name-text">{{ noteInfo.productName }}</span>
                    <span class="product-price-text">￥{{ noteInfo.productPrice }}</span>
                  </div>
                </div>
              </div>
            </div>
...
import {Close, Star, ChatRound, StarFilled, ArrowDown, ArrowRight} from "@element-plus/icons-vue";
