    ...
    <div class="main">
      <div class="side-bar">
        <ul class="channel-list">
          ...
          <li :class="activeLink == 4 ? 'active-channel' : ''" @click="toLink(4)">
            <ShoppingCart style="width: 1.3em; height: 1.3em; margin-right: 8px" />
            <span class="channel">好物集市</span>
          </li>

          <div v-if="userInfo == null">
            <el-button type="danger" round @click="login" class="custom-button">登录</el-button>
          </div>
          <li v-else :class="activeLink == 5 ? 'active-channel' : ''" @click="toLink(5)">
            ...
            <div class="container">
              <div class="group-wrapper">
                <a
                  ...
                  target="_blank"
                  href="https://yangleibigcoolman.top"
                >
                  <span>关于作者</span>
                  <div class="icon">
...
const routerList = ["/dashboard", "/followTrend", "/notice", "/push", "/shop", "/user"];
...
/* 修改后的选中样式 */
.active-channel {
  background-color: rgba(0, 0, 0, 0.03) !important; /* 保持浅灰色背景 */
  border-radius: 999px;
  width: 90%;
}
...
.active-channel svg {
  color: #ff2442 !important; /* 小红书红 */
  fill: #ff2442 !important;  /* 确保图标也变红 */
}
    ...
    .side-bar {
      ...
      .channel-list {
        ...
        .active-channel {
          ...
          border-radius: 999px;
          width: 90%;
          color: #ff2442 !important; /* 这里变为小红书红 */
        }
